...
% Gradient Grid             
    ...
    [pathstr,name,ext]=fileparts('H:\2k19\_UROP\MRiLab-master\MRiLab-master\Config\Grad\Head\Grad_LinearHead\Grad_LinearHead.XML');
...
if VObj.SpinNum >1
    ...
    [pathstr,name,ext]=fileparts('H:\2k19\_UROP\MRiLab-master\MRiLab-master\Config\Mag\Head\Mag_LinearHead\Mag_LinearHead.XML');
    eval(['dB0=' name ';']);
    VMag.dB0=dB0;
...
%if isfield(Simuh,'CoilRxXMLFile')
   % if ~isfield(Simuh,'CoilTxXMLFile')
    ...
    [pathstr,name,ext]=fileparts('H:\2k19\_UROP\MRiLab-master\MRiLab-master\Config\Coil\Head\Coil_1ChHead\Coil_1ChHead.xml');
...
%Shouldn't this be set to default - stationary? as we aren't dealing with
%any moving scans
    [pathstr,name,ext]=fileparts('H:\2k19\_UROP\MRiLab-master\MRiLab-master\Config\Mot\Head\Mot_ShiftHead\Mot_ShiftHead.XML');

...
TmpTR=10; % Dummy reserve
TmpFlipAng=VCtl.FlipAng;

%% Compile PSD XML to m function
seqdir='H:\2k19\_UROP\MRiLab-master\MRiLab-master\PSD\3D\GradientEcho\PSD_GRE3D\PSD_GRE3D.xml';
DoWriteXML2m(DoParseXML(seqdir),[seqdir(1:end-3) 'm']);
clear functions;  % remove the M-functions from the memory
[pathstr,name,ext]=fileparts(seqdir);
